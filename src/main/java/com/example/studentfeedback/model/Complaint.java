...
public class Complaint {
	...
	//constructors
	public Complaint(long complaintId, Date complaintRegisteredDate, String department, String category, String details,
			String desiredOutcome, String status,String role) {
		super();
		this.complaintId = complaintId;
		this.complaintRegisteredDate = complaintRegisteredDate;
		this.department = department;
